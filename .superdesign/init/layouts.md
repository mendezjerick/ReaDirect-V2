...
The public landing page is self-contained and owns its header, navigation, content sections, and footer. It does not inherit an application shell. This is the exact rendered layout source for `/landing`.

## BrowserLandingPage

- Source: `apps/web/src/features/landing/BrowserLandingPage.tsx`
- Public landing layout with sticky navigation, hero, offline preview, about, features, CTA, and footer
