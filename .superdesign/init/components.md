...
- Vite build system
- Custom UI primitives and plain CSS
- Tailwind is available but the landing page uses dedicated CSS

## PixelIcon

- Source: `apps/web/src/components/ui/PixelIcon.tsx`
- Shared landing utility icon renderer
- Props: `name`, optional `className`, optional `title`
