...
This directory is contributor-ready as game slot two. Keep it at
`apps/games/game-two` in the standalone starter so it can be merged without
relocating files. Do not edit `apps/games/lobby` or game one.
