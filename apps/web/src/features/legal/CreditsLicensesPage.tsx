...
export function CreditsLicensesPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="credits-licenses__hero">
          <p>About ReaDirect</p>
        ...
        <div className="credits-licenses__content">
          <section aria-labelledby="credits-creators">
            ...
            <p>
              ReaDirect&apos;s app icon, logo, and pixel-art identity were
              created by Jerick E. Mendez. Researcher and developer profile
              photographs are used with the team&apos;s approval.
            </p>
            <p>
              Learning backgrounds and game-lobby thumbnails were generated for
              ReaDirect using the project&apos;s AI-generation workflows.
              Selected Game One art was generated for ReaDirect with ChatGPT.
            </p>
          </section>
            ...
            <dl>
              ...
              <div>
                ...
                <dd>
                  ...
                  Sofia Thirslund, Asbjørn Thirslund, and Jayvee Enaguas (Pixel
                  Operator). Attribution is preserved although not required by
                  the licence.
                </dd>
              </div>
            </dl>
          ...
          <section aria-labelledby="credits-fonts">
            ...
            <p>
              Fredoka, Lexend, Pixelify Sans, and Jersey 20 are distributed
          ...
          <section aria-labelledby="credits-software">
            ...
            <p>
              ReaDirect uses open-source JavaScript, PHP, and Python
              dependencies. A full dependency licence notice will be published
              with the Play Store release package.
            </p>
          </section>
        </div>
      </article>
