...
export const claraLettersCopy = {
  en: {
    ...
    speakingStory: "Listen to Ma'am Clara's story.",
    speakingTeach: "Watch the pair and listen to its letter name.",
    audioError: "That story sound needs another try.",
    retryAudio: "Try the sound again",
  ...
  fil: {
    ...
    speakingStory: "Pakinggan ang kuwento ni Ma'am Clara.",
    speakingTeach: "Tingnan ang pares at pakinggan ang pangalan ng letra.",
    audioError: "Kailangang subukan muli ang tunog ng kuwento.",
    retryAudio: "Subukan muli ang tunog",
...
export const claraPracticeCopy = {
  en: {
    ...
    welcomeTitle: "Listen, then give it a try.",
    welcomeMessage: (count: number) =>
      `Ma'am Clara will read each item aloud before you answer. There are ${count} short challenges.`,
    ...
    preparing: "Ma'am Clara is getting this practice item ready.",
    speaking: "Listen to Ma'am Clara before you answer.",
    audioError: "That voice line needs another try.",
    listenHint: "The activity will unlock when Clara finishes speaking.",
    retryAudioHint: "Use the speaker button to try the voice line again.",
    replay: "Replay",
    loading: "Loading",
    playing: "Playing",
    tryAudioAgain: "Try again",
  ...
  fil: {
    ...
    ready: "Handa na ang iyong pagsasanay.",
    welcomeTitle: "Makinig, pagkatapos ay subukan.",
    welcomeMessage: (count: number) =>
      `Babasahin muna ni Ma'am Clara ang bawat item bago ka sumagot. May ${count} maiikling hamon.`,
    ...
    preparing: "Inihahanda ni Ma'am Clara ang pagsasanay na ito.",
    speaking: "Pakinggan muna si Ma'am Clara bago sumagot.",
    audioError: "Kailangang subukan muli ang voice line na ito.",
    listenHint: "Magbubukas ang gawain kapag tapos nang magsalita si Clara.",
    retryAudioHint:
      "Gamitin ang speaker button para subukan muli ang voice line.",
    replay: "Pakinggan muli",
    loading: "Nilo-load",
    playing: "Pinapatugtog",
    tryAudioAgain: "Subukan muli",
